...
namespace WebApiCrud.Extentions
{
    public static class CustomJwtAuthExtention
    {
        ...
        public static void AddSwagerGenJwtAuth(this IServiceCollection services)
        {
            ...
            o.SwaggerDoc("v1",new OpenApiInfo(){ 
                Version="V1",
                Title="Zad ElKhier",
                Description="This Is My Owen Project",
                Contact= new OpenApiContact()
                {
                    Name="Ali Al FAteh Al Guhny",
                    Email="A.Zakarya19.870@gmail.com",
                    Url=new Uri("http://mydomain.com")
                }
            });
            ...
            o.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme() { 
                ...
                Description="Enter JWT Key Please"
